                ...
                <div class="activity-listen global-activity-container global-shadow-radius-bottom">
                    <div class="col-sm-4 audio-container">
                        <div class="audio-Name1">
                            ...
                            <div class="icon-audio">
                                <a class="btn btn-dark btn-social mx-2 icon-play" href="#!"><i
                                        class="fas fa-play"></i></a>
                                <a class="btn btn-dark btn-social mx-2 icon-volume" href="#!"><i
                                        class="fas fa-volume-up"></i></a>
                                <a class="btn btn-dark btn-social mx-2 icon-pause" href="#!"><i
                    ...
                    <div class="col-sm-8 paragraph-container">
                        <div class="listen-word" id="listen-word">
                            <img alt=""
                                src="https://media.ucan.vn/upload/userfiles/organizations/1/1/img/Listening-elementary/1-name/hotel.jpg"
                                style="width: 380px; height: 250px; float: right; margin-right: -40px;">
                            @foreach ($listens_word as $key => $word)
                            <span class="choices-container">
                                <p class="word-true" status="{{$word['status_true']}}">{{ $key+1}}.
                                    {{$word['word_true']}} /</p>
