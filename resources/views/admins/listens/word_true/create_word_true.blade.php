...
<div class="container">
    <div class="row">
        <div class="col col-sm-6 ">
            <h3>Mời bạn thêm đáp án </h3>
            <br>

            <form action="{{route('word_true.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="cars">Status_true </label>
                ...
                <div class="mb-3">
                    <label for="" class="form-label">Word_true</label>
                    <input type="text" class="form-control" id="" name="word_true" require="" value="{{ old('word_true')}}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="" name="word_false" require="" value="{{ old('word_false')}}">
                    <div id="" class="form-text"></div>
