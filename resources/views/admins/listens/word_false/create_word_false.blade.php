...
<div class="container">
    <div class="row">
        <div class="col col-sm-6 ">
            <h3>Mời bạn thêm đáp án False </h3>
            <br>

            <form action="{{route('word_false.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="cars">Word_false </label>
                ...
                <div class="mb-3">
                    <label for="" class="form-label">Đáp án False</label>
